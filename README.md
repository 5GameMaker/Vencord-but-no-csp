# Vencord (but with no CSP)

> ⚠️
>
> This fork is __***dangerously unsafe***__!
>
> Use it on your own risk. Vencord updates will be delayed. Since CSP is completely disabled,
> attackers may run untrusted code on your machine. Beware of the `<script>` tag!
...
- Download Vencord from <https://vencord.dev/download>
...
> ⚠️
>
> Before reporting bugs make sure you can reproduce them in [vanilla Vencord](https://github.com/Vendicated/Vencord)
> and vanilla Discord!
>
> If a bug cannot be reproduced, open an issue here instead.
...
<a href="https://star-history.com/#5GameMaker/Vencord-but-no-csp&Timeline">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=5GameMaker/Vencord-but-no-csp&type=Timeline&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=5GameMaker/Vencord-but-no-csp&type=Timeline" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=5GameMaker/Vencord-but-no-csp&type=Timeline" />
  </picture>
</a>
