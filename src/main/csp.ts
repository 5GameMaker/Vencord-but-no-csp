...
export const CspPolicies: PolicyMap = {
    "*": [...ConnectSrc, "unsafe-eval", "unsafe-inline"], // fuck it we ball
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        headers[header] = [[
            "default-src * data: mediastream: blob: filesystem: about: ws: wss: vencord: 'unsafe-eval' 'wasm-unsafe-eval' 'unsafe-inline'; ",
            "script-src * data: blob: vencord: 'unsafe-inline' 'unsafe-eval'; ",
            "script-src-elem * data: blob: vencord: 'unsafe-inline' 'unsafe-eval';",
            "connect-src * data: blob: vencord: 'unsafe-inline'; ",
            "img-src * data: blob: vencord: 'unsafe-inline'; ",
            "media-src * data: blob: vencord: 'unsafe-inline'; ",
            "frame-src * data: blob: vencord: ; ",
            "style-src * data: blob: vencord: 'unsafe-inline';",
            "font-src * data: blob: vencord: 'unsafe-inline';",
            "frame-ancestors * data: blob: vencord:;",
        ].join(" ")];
    }
};
